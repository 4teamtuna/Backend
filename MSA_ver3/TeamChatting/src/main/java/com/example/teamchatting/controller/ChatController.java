...
public class ChatController {
    ...
    public Mono<ChatTeamResponse> createRoom(@PathVariable("contestId") Integer contestId, @RequestBody TeamRequestDto teamRequestDto) {
        return contestClientService.getContestById(contestId).map(contestDto -> {
            Team team = new Team();
