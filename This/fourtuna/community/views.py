...
def board_write(request):
    if request.method == 'POST':
        ...
        form = BoardForm()
    return render(request, 'community/templates/board_write.html', {'form' : form})
...
def board_list(request):
    ...
    return render(request, 'community/templates/board_list.html', {'boards' : boards})
...
def board_detail(request, pk): # 몇번째 글인지 확인하기 위해 주소로부터 pk를 받음
    ...
    return render(request, 'community/tempplates/board_detail.html', {'board' : board}) #템플릿에 전달