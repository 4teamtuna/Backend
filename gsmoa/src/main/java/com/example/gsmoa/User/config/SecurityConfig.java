    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/login", "/", "/join", "/v3/**", "/swagger-ui/**", "/ws/chat/**", "/teams/**", "/contest/**", "/contestImg/**", "/contestImgs/**", "/contestImgsURL/**", "/main/community/**", "/ws/notification/**", "/queue/notification").permitAll()
